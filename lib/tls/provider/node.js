...
function MD5SHA1(crypto) {
  this.digest = new md5sha1.Digest();
}
MD5SHA1.out = new Buffer(36);

MD5SHA1.prototype.update = function update(buf) {
...
MD5SHA1.prototype.sign = function sign(key) {
  this.digest.digest(MD5SHA1.out);
  return md5sha1.sign(MD5SHA1.out, key);
};
...
MD5SHA1.prototype.verify = function verify(key, content) {
  ...
  this.digest.digest(MD5SHA1.out);
  return md5sha1.verify(MD5SHA1.out, content, key);
};
