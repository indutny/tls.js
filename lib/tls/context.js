...
Context.prototype.setMinVersion = function setMinVersion(major, minor) {
  this.minVersion = ((major << 8) & 0xff) | (minor & 0xff);
};

Context.prototype.setMaxVersion = function setMaxVersion(major, minor) {
  this.maxVersion = ((major << 8) & 0xff) | (minor & 0xff);
};
